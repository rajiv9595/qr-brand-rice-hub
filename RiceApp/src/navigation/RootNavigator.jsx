...
import TraderEditProfile from '../screens/trader/TraderEditProfile';

// Common Screens
import EditProfile       from '../screens/common/EditProfile';
import NegotiationHub    from '../screens/common/NegotiationHub';
import SupportHub        from '../screens/common/SupportHub';
...
const BuyerAppStack = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="NegotiationHub" component={NegotiationHub} />
    <Stack.Screen name="SupportHub" component={SupportHub} />
  </Stack.Navigator>
);
...
const TraderAppStack = () => (
  <Stack.Navigator screenOptions={{ headerShown: false }}>
    ...
    <Stack.Screen name="EditProfile" component={TraderEditProfile} />
    <Stack.Screen name="NegotiationHub" component={NegotiationHub} />
    <Stack.Screen name="SupportHub" component={SupportHub} />
  </Stack.Navigator>
);
